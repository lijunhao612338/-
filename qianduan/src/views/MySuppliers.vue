    ...
    <div class="tab">
      <div class="control">
        <div class="add">
          ...
          <button @click='opendata()' style='width:100px;'>上传出库信息</button>
        </div>
        <div class="cz">
          <button>导出</button>
      ...
      <el-dialog title="入库信息详情" :visible.sync="dialogTableVisible">
        <el-table :data="[gridData]" :height="500 + 'px'" style="width: 100%">
          <el-table-column property="drugInformation" label="药品信息" width="280"></el-table-column>
          ...
          <el-table-column prop="genericName" label="药品通用名" show-overflow-tooltip width="280px"></el-table-column>
          <el-table-column prop="dosageForm" label="剂型" show-overflow-tooltip width="180px"></el-table-column>
          <el-table-column prop="manufacturer" label="生产厂商" show-overflow-tooltip width="180px"></el-table-column>
          <el-table-column prop="approvalNumber" label="批准文号" show-overflow-tooltip width="180px"></el-table-column>
          ...
          <el-table-column property="xiangqing" label="详情" width="100">
            <template>
              <el-tag size="medium">
                <el-button type="text" @click="opendata()">
                  <i class="el-icon-edit"></i>
                </el-button>
              </el-tag>
            </template>
                ...
                <div slot="reference" class="name-wrapper">
                  <el-tag size="medium">
                    <i class="el-icon-edit">
                      <el-button type="text" @click="opendata1()">
